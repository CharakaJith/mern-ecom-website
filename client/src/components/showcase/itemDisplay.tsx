...
const ItemDisplay: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-start pt-24 pb-10 px-4">
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-3">
              {item.sizes.map((size, idx) => (
                <span key={idx} className="px-4 py-2 border rounded-lg cursor-pointer bg-gray-200 hover:bg-gray-300">
                  {size}
                </span>
              ))}
            </div>
